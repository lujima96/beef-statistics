...
def apply_sql(args: argparse.Namespace) -> None:
    ...
    order = [
        ...
        SQL_DIR / "65_diesel_prices.sql",
        SQL_DIR / "66_supply_demand_indices.sql",
        SQL_DIR / "67_delivery_estimator.sql",
        SQL_DIR / "70_receipts.sql",
        SQL_DIR / "71_fuel_receipts_comments.sql",
        SQL_DIR / "72_maintenance_entries.sql",
        SQL_DIR / "73_maintenance_report_date_fk.sql",
        SQL_DIR / "74_route_logs.sql",
        SQL_DIR / "75_stops_in_route.sql",
        SQL_DIR / "76_fuel_stops.sql",
