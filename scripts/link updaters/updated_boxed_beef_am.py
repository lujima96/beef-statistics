#!/usr/bin/env python3
"""Update the Boxed Beef AM link list from the MyMarketNews filerepo."""
...
def _is_target_asset(href: str) -> bool:
    ...
    return path.endswith(PDF_SUFFIXES)
