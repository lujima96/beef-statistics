...
import RouteSelector from '@/sidebar/search/RouteSelector'
...
import useDeliveryEstimatorLayer from '@/layers/UseDeliveryEstimatorLayer'

export const POPUP_CONTAINER_ID = 'popup-container'
export const SIDEBAR_CONTENT_ID = 'sidebar-content'
const DELIVERY_ROUTE_PARAM = 'deliveryRouteId'
const DELIVERY_MULTI_RUN_PARAM = 'multiRun'
...
export default function App() {
    ...
    const deliveryRouteIdParam = searchParams.get(DELIVERY_ROUTE_PARAM)
    const deliveryRouteId = deliveryRouteIdParam && !Number.isNaN(Number(deliveryRouteIdParam)) ? Number(deliveryRouteIdParam) : null
    const deliveryMultiRunVersion = searchParams.get(DELIVERY_MULTI_RUN_PARAM)
    ...
    useDeliveryEstimatorLayer(map, deliveryRouteId, deliveryMultiRunVersion)
